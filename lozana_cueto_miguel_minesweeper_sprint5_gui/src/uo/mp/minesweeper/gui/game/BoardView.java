...
import uo.mp.minesweeper.gui.game.icons.Icons;
import uo.mp.minesweeper.gui.swing.OnSwingThread;
import uo.mp.util.check.ArgumentChecks;

/**
 * Builds the window (the View) and links it with the Presenter
 */
/*package*/ class BoardView extends BoardScreen implements GamePresenter.View {
	...
	public boolean isOpen() {
		return window.isVisible();   // thread unsafe, but assumable risk
	}
